...
import com.example.owfm.databinding.FragmentDisposeBinding;

public class DisposeFragment extends Fragment {

   FragmentDisposeBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDisposeBinding.inflate(getLayoutInflater());
        setupUi();
    ...
    private void setupUi() {
        ...
        binding.disposeToolbar.setNavigationIcon(R.drawable.ic_arrow_back);

        //navigate to home when toolbar back button is clicked
        binding.disposeToolbar.setOnClickListener(view -> Navigation.findNavController(view).navigate(R.id.homeScreenFragment));
